...
This folder contains small web projects I created using HTML, CSS, and sometimes JavaScript.  
These projects were built to practice layout, styling, animations, and basic front-end logic.

## 🌐 Projects

### **Project 1 – (nomusic)**
- Description: A dynamic event website highlighting music shows with bold visuals and a clean, modern layout.
- Project 1: [View project](project-1)
...
- Project 2: [View project](project-2)
...
- Project 3: [View project](project-3)
